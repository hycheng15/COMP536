...
def build_pkt(iface, dst_ip, l4proto, sport, dport, paylen):
    mac = get_if_hwaddr(iface)
    pkt = (
...
def main():
    ...
    ap.add_argument("--seed", type=int, default=None,
                            help="Set random seed for reproducibility (default = current time)")
    args = ap.parse_args()
    ...
    for f in range(args.flows):
        ...
        pkt = build_pkt(iface, args.dst, l4proto, sport, dport, paylen)
